...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item {{ Route::is('kalender_beasiswa.index') ? 'menu-open' : '' }}
    ...
    <ul class="nav nav-treeview {{ Route::is('kalender_beasiswa.index') || Route::is('user.index') || Route::is('level_user.index') || Route::is('tingkat_studi.index') || Route::is('negara.index') || Route::is('benua.index') ? 'menu-open' : '' }}">
        <li class="nav-item">
