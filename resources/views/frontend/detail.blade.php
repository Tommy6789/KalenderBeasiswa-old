...
<style>
    .page-section {
        padding: 4rem 0; /* Ensure adequate padding for sections */
    }

    .container {
        padding: 0 2rem; /* Increase left and right padding for the entire container */
    }
    ...
    .display-4 {
        font-size: 2.5rem; /* Adjust as needed for title size */
    }

    .display-5 {
        font-size: 2rem; /* Adjust as needed for section headings */
    }
    ...
    .mb-3 {
        margin-bottom: 1.5rem; /* Space between elements within a section */
    }
    ...
    <div class="container">
        ...
        <div class="date-card mb-5">
            ...
            <div class="date-row">
                ...
                <p class="date-deadline text-danger">{{ $data                                                                           ->deadline }}</p>
            </div>
        </div>
