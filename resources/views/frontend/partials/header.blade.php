        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto my-2 my-lg-0">
                    ...
                    {{-- Nav Homepage --}}
                    @if (Str::contains(request()->fullUrl(), 'detail'))
                        <!-- Check if the current URL contains 'detail' -->
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('homepage') }}">Kembali Ke Homepage</a>
                        </li>
                    @else
                        <li class="nav-item">
                    ...
                    {{-- Nav Kalender Beasiswa --}}
                    @if (Str::contains(request()->fullUrl(), 'detail'))
                        <!-- Check if the current URL contains 'detail' -->
                        <li class="nav-item">
                            <a class="nav-link" href="#DetailKalenderBeasiswa">Detail Kalender Beasiswa</a>
                        </li>
                    @else
                        <li class="nav-item">
